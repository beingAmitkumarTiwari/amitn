...
public class NotifyonThree extends BroadcastReceiver {
    @Override
    public void onReceive(Context context, Intent intent) {
        //Toast.makeText(context, "I'm running", Toast.LENGTH_SHORT).show();
        int notifyID = 0;
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(context)
                .setSmallIcon(R.drawable.political)
//                .setColor(getResources().getColor(R.color.notifyone))
                .setContentTitle("Politics News")
                .setContentText("See the latest news about Politics!");
