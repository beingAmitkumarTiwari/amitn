...
public class NotifyonTwelve extends BroadcastReceiver {
    @Override
    public void onReceive(Context context, Intent intent) {
        //Toast.makeText(context, "I'm running", Toast.LENGTH_SHORT).show();
        int notifyID = 0;
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(context)
                .setSmallIcon(R.drawable.celebs)
//                .setColor(getResources().getColor(R.color.notifyone))
                .setContentTitle("Celebs News")
                .setContentText("See the latest news about Celebs and Entertainment!");
